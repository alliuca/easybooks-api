module.exports = (doc, data) => {
  ...
  doc.fontSize(fontSizeBody)
    .fillColor(secondaryColor)
    .text('Totale Fattura', page.width - (200 + paddingHorizontal), 150, { width: 200, align: 'right' });
  ...
  doc.fontSize(fontSizeTableHeading)
    .fillColor(primaryColor)
    .text('Importo', page.width - (70 + paddingHorizontal), 305, { width: 70, align: 'right' });
  ...
  doc.fontSize(fontSizeTableHeading)
    .fillColor(primaryColor)
    .text(`Subtotale\n${fees.names}Totale\n\nImporto Dovuto (EUR)`, 250, 515, { width: 200, align: 'right', lineGap: 12 });
